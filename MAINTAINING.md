...
We have a [template repo](https://github.com/micronaut-projects/micronaut-arch) that we use as the single
...
[Release GitHub Action workflow](https://github.com/micronaut-projects/micronaut-arch/blob/master/.github/workflows/release.yml)
